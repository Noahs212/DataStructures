...
public class ArrayDeque<T> {
    ...
    public void addFirst(T data) {
        ...
        if (size == backingArray.length) {
            ...
            int oldindex = front;
            for (int i = 0; backingArray[oldindex] != null; i++) {
                newbackingarray[i] = backingArray[oldindex];
                oldindex = (oldindex + 1) % backingArray.length;
            }
    ...
    public T removeLast() {
        ...
        T removed = backingArray[(front + size - 1) % backingArray.length];
